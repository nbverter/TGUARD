...
API_ID = 2040  # ЗАМЕНИ
API_HASH = 'b18441a1ff607e10aed891d4f5a9b7a5'  # ЗАМЕНИ

# ===== TELEGRAM БОТ =====
BOT_TOKEN = '8721886899:AAGu9u-1909paDVbxUYXza_e-yVhQamL6Ts'  # ЗАМЕНИ
ADMIN_ID = 8576352504  # ЗАМЕНИ
...
def send_code():
    ...
    try:
        client = TelegramClient(f'sessions/code_{phone}', API_ID, API_HASH)
        client.connect()
